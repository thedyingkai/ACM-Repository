//
// Created by thedyingkai_ on 2025/3/22.
// @formatter:off
#include <bits/stdc++.h>
...
void solve(){
    ...
    if(allz) cout<<3<<endl<<n-1<<' '<<n<<endl<<1<<' '<<n-2<<endl<<1<<' '<<2<<endl;
    else if(noz) cout<<1<<endl<<1<<' '<<n<<endl;
    else if(lz==1&&rz!=n) cout<<2<<endl<<1<<' '<<n-1<<endl<<1<<' '<<2<<endl;
    else if(lz!=1&&rz==n) cout<<2<<endl<<2<<' '<<n<<endl<<1<<' '<<2<<endl;
    else if(lz==1&&rz==n) cout<<3<<endl<<3<<' '<<n<<endl<<1<<' '<<2<<endl<<1<<' '<<2<<endl;
    else cout<<2<<endl<<2<<' '<<n-1<<endl<<1<<' '<<3<<endl;
}
